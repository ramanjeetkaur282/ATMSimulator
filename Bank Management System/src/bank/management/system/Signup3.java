...
public class Signup3 extends JFrame implements ActionListener{
    ...
    JLabel number= new JLabel("XXXX-XXXX-XXXX-5789");
   ...
   getContentPane().setBackground(Color.WHITE);
    ...
    public void actionPerformed(ActionEvent ae){
       if(ae.getSource()==submit){
           ...
           else if(r2.isSelected()){ accountType = "Checking Account"; }
           else if(r3.isSelected()){ accountType = "Fixed Deposit"; }
           else if(r4.isSelected()){ accountType = "Recurring Account"; }
           
           
           Random random=new Random();
           String cardnumber= ""+ Math.abs((random.nextLong()%90000000L)+ 5960936000000000L);
